...
and a flow chart. You author formulae as a **node graph**: components have
...
The wedge use case is **engineering, estimating, and AEC** — where unit mistakes
...
GuyLine won't: the dimensional checker is a correctness *oracle*, and the same
...
Three load-bearing goals: (1) strict engine/UI separation, (2) keep the engines
